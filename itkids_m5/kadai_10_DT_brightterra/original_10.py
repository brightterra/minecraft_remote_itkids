...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+12, param.Y_SEA+3, width-4,    -width+12, param.Y_SEA+6, width-4,    param.DARK       )
    mc.setBlocks(-width+20, param.Y_SEA+3, width-4,    -width+20, param.Y_SEA+6, width-4,    param.DARK       )
    mc.setBlocks(-width+28, param.Y_SEA+3, width-4,    -width+28, param.Y_SEA+6, width-4,    param.DARK       )
    mc.setBlocks(width-4,   param.Y_SEA+3, width-4,    width-4,   param.Y_SEA+6, width-4,    param.DARK       )
    mc.setBlocks(width-4,   param.Y_SEA+3, width-12,   width-4,   param.Y_SEA+6, width-12,   param.DARK       )
    mc.setBlocks(width-4,   param.Y_SEA+3, width-20,   width-4,   param.Y_SEA+6, width-20,   param.DARK       )
    mc.setBlocks(width-4,   param.Y_SEA+3, width-28,   width-4,   param.Y_SEA+6, width-28,   param.DARK       )        
    mc.setBlocks(width-4,   param.Y_SEA+3, -width+5,   width-4,   param.Y_SEA+6, -width+5,   param.DARK       )
    mc.setBlocks(width-12,   param.Y_SEA+3, -width+5,   width-12,   param.Y_SEA+6, -width+5,   param.DARK       )
    mc.setBlocks(width-20,   param.Y_SEA+3, -width+5,   width-20,   param.Y_SEA+6, -width+5,   param.DARK       )
    mc.setBlocks(width-28,   param.Y_SEA+3, -width+5,   width-28,   param.Y_SEA+6, -width+5,   param.DARK       )
