...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+9,  param.Y_SEA+10, width-16,   -width+9,  param.Y_SEA+15, width-16,   param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+10, -width+16,  -width+9,  param.Y_SEA+15, -width+16,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+16, -width+5,   width-5,   param.Y_SEA+16, width-5,    param.SPRUCE     )
    mc.setBlocks(-width+8,  param.Y_SEA+17, -width+8,   width-8,   param.Y_SEA+17, width-8,    param.SPRUCE     )
    mc.setBlocks(-width+10, param.Y_SEA+18, -width+10,  width-10,  param.Y_SEA+18, width-10,   param.SPRUCE     )
    mc.setBlocks(-width+11, param.Y_SEA+19, -width+11,  width-11,  param.Y_SEA+19, width-11,   param.SPRUCE     )
