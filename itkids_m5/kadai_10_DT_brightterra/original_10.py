...
def Kinkakuji(mc, width=80):
    ...
    mc.setBlocks(-width/2, param.Y_SEA,   -width/2,   width/2, param.Y_SEA,   width/2, param.STONE     )
    mc.setBlocks(-width/2, param.Y_SEA+1, -width/2,   width/2, param.Y_SEA+1, width/2, param.HARF_STONE)
