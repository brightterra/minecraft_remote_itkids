...
def Kinkakuji(mc, width=20 ,X=0 ,Z=0):
    ...
    mc.setBlock( width-3+X,   param.Y_SEA+7,  Z,            param.TORCH      )
    mc.setBlocks(width-4+X,   param.Y_SEA+3,  width-28+Z,   width-4+X,   param.Y_SEA+8,  width-28+Z,   param.DARK       )
    mc.setBlock( width-4+X,   param.Y_SEA+6,  width-28+Z,   param.FENCE      )
    mc.setBlock( width-4+X,   param.Y_SEA+7,  width-28+Z,   param.TORCH      )
    mc.setBlock( width-3+X,   param.Y_SEA+6,  width-29+Z,   param.FENCE      )
    mc.setBlock( width-3+X,   param.Y_SEA+7,  width-29+Z,   param.TORCH      )
