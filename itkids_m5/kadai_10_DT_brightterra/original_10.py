...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+4,  param.Y_SEA+3,  -width+5,   width-4,   param.Y_SEA+7,  -width+5,   param.DARK       )
    ...
    mc.setBlocks(-width+6,  param.Y_SEA+8,  -width+7,   width-6,   param.Y_SEA+8,  width-6,    param.AIR        )
