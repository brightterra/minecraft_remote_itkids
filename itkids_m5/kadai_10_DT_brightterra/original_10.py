...
def Kinkakuji(mc, width=20 ,X=0 ,Z=0):
    ...
    mc.setBlock( width-15+X,  param.Y_SEA+13, width-28+Z,   param.FENCE      )
    mc.setBlock( width-15+X,  param.Y_SEA+14, width-28+Z,   param.TORCH      )
    ...
    mc.setBlock( width-25+X,  param.Y_SEA+13, width-29+Z,   param.FENCE      )
    mc.setBlock( width-25+X,  param.Y_SEA+14, width-29+Z,   param.TORCH      )
    ...
    mc.setBlock( width-26+X,  param.Y_SEA+13, -width+5+Z,   param.FENCE      )
    mc.setBlock( width-26+X,  param.Y_SEA+14, -width+5+Z,   param.TORCH      )
    mc.setBlocks(-width+5+X,  param.Y_SEA+10, -width+5+Z,   -width+5+X,  param.Y_SEA+15, -width+5+Z,   param.DARK       )
    mc.setBlock( -width+5+X,  param.Y_SEA+13, -width+4+Z,   param.FENCE      )
    mc.setBlock( -width+5+X,  param.Y_SEA+14, -width+4+Z,   param.TORCH      )
    mc.setBlock( -width+4+X,  param.Y_SEA+13, -width+5+Z,   param.FENCE      )
    ...
    mc.setBlocks(-width+1+X,  param.Y_SEA+17, -width+1+Z,   width-1+X,   param.Y_SEA+16, width-1+Z,    param.SPRUCE     )
    mc.setBlocks(-width+4+X,  param.Y_SEA+18, -width+4+Z,   width-4+X,   param.Y_SEA+17, width-4+Z,    param.SPRUCE     )
    mc.setBlocks(-width+6+X,  param.Y_SEA+19, -width+6+Z,   width-6+X,   param.Y_SEA+18, width-6+Z,    param.SPRUCE     )
    mc.setBlocks(-width+8+X,  param.Y_SEA+20, -width+8+Z,   width-8+X,   param.Y_SEA+19, width-8+Z,    param.SPRUCE     )
    mc.setBlocks(-width+9+X,  param.Y_SEA+21, -width+9+Z,   width-9+X,   param.Y_SEA+20, width-9+Z,    param.GOLD_BLOCK )
    mc.setBlock( -width+1+X,  param.Y_SEA+15, -width+1+Z,   param.LANTERN )
    mc.setBlock( width-1+X,   param.Y_SEA+15, -width+1+Z,   param.LANTERN )
    mc.setBlock( -width+1+X,  param.Y_SEA+15, width-1+Z,    param.LANTERN )
    mc.setBlock( width-1+X,   param.Y_SEA+15, width-1+Z,    param.LANTERN )
    mc.setBlocks(-width+9+X,  param.Y_SEA+21, -width+9+Z,   width-9+X,   param.Y_SEA+21, width-9+Z,    param.FENCE      )
    mc.setBlocks(-width+10+X, param.Y_SEA+21, -width+10+Z,  width-10+X,  param.Y_SEA+21, width-10+Z,   param.AIR        )
    mc.setBlocks(-width+12+X, param.Y_SEA+21, -width+12+Z,  width-12+X,  param.Y_SEA+24, width-12+Z,   param.GOLD_BLOCK )
    mc.setBlocks(-width+12+X, param.Y_SEA+23, -width+12+Z,  width-12+X,  param.Y_SEA+23, width-12+Z,   param.DARK       )
    mc.setBlocks(-width+12+X, param.Y_SEA+25, -width+12+Z,  width-12+X,  param.Y_SEA+25, width-12+Z,   param.DARK       )
    mc.setBlocks(-width+13+X, param.Y_SEA+21, -width+13+Z,  width-13+X,  param.Y_SEA+24, width-13+Z,   param.AIR        )
    mc.setBlocks(-width+13+X, param.Y_SEA+25, -width+13+Z,  width-13+X,  param.Y_SEA+25, width-13+Z,   param.GLOWSTONE  )
