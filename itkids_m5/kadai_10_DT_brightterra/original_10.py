...
def Kinkakuji(mc, width=20 ,X=0 ,Z=0):
    ...
    mc.setBlocks(-width+7+X,  param.Y_SEA+19, -width+7+Z,   width-7+X,   param.Y_SEA+18, width-7+Z,    param.SPRUCE     )
    mc.setBlocks(-width+10+X, param.Y_SEA+20, -width+10+Z,  width-10+X,  param.Y_SEA+19, width-10+Z,   param.SPRUCE     )
    mc.setBlocks(-width+12+X, param.Y_SEA+21, -width+12+Z,  width-12+X,  param.Y_SEA+20, width-12+Z,   param.GOLD_BLOCK )
    ...
    mc.setBlocks(-width+13+X, param.Y_SEA+21, -width+13+Z,  width-12+X,  param.Y_SEA+21, width-12+Z,   param.AIR        )
