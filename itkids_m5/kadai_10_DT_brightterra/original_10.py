...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(width-5,   param.Y_SEA+10, -width+5,   width-24,  param.Y_SEA+14, -width+11,  param.AIR        )
    mc.setBlocks(-width+9,  param.Y_SEA+10, -width+9,   -width+9,  param.Y_SEA+15, -width+5,   param.DARK       )
    mc.setBlocks(-width+16, param.Y_SEA+10, -width+9,   -width+16, param.Y_SEA+15, -width+5,   param.DARK       )
    mc.setBlocks(width-16,  param.Y_SEA+10, -width+9,   width-16,  param.Y_SEA+15, -width+5,   param.DARK       )
    mc.setBlocks(width-9,   param.Y_SEA+10, -width+9,   width-9,   param.Y_SEA+15, -width+5,   param.DARK       )
