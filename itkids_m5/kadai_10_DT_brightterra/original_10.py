...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+8,  param.Y_SEA+12, -width+8,   width-8,   param.Y_SEA+12, width-8,    param.GOLD_BLOCK )
    mc.setBlocks(-width+9,  param.Y_SEA+12, -width+9,   width-9,   param.Y_SEA+12, width-9,    param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+13, -width+9,   width-9,   param.Y_SEA+13, width-9,    param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+14, -width+9,   width-9,   param.Y_SEA+17, width-9,    param.GOLD_BLOCK )
    mc.setBlocks(-width+9,  param.Y_SEA+16, -width+9,   width-9,   param.Y_SEA+16, width-9,    param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+18, -width+9,   width-9,   param.Y_SEA+18, width-9,    param.DARK       )
    mc.setBlocks(-width+10, param.Y_SEA+13, -width+10,  width-10,  param.Y_SEA+17, width-10,   param.AIR        )
    mc.setBlocks(-width+10, param.Y_SEA+18, -width+10,  width-10,  param.Y_SEA+18, width-10,   param.GLOWSTONE  )
    mc.setBlocks(-width+9,  param.Y_SEA+13, -width+9,   -width+9,  param.Y_SEA+17, -width+9,   param.DARK       )
    mc.setBlocks(-width+16, param.Y_SEA+13, -width+9,   -width+16, param.Y_SEA+17, -width+9,   param.DARK       )
    mc.setBlocks(width-16,  param.Y_SEA+13, -width+9,   width-16,  param.Y_SEA+17, -width+9,   param.DARK       )
    mc.setBlocks(width-9,   param.Y_SEA+13, -width+9,   width-9,   param.Y_SEA+17, -width+9,   param.DARK       )
    mc.setBlocks(width-9,   param.Y_SEA+13, -width+16,  width-9,   param.Y_SEA+17, -width+16,  param.DARK       )
    mc.setBlocks(width-9,   param.Y_SEA+13, width-16,   width-9,   param.Y_SEA+17, width-16,   param.DARK       )
    mc.setBlocks(width-9,   param.Y_SEA+13, width-9,    width-9,   param.Y_SEA+17, width-9,    param.DARK       )
    mc.setBlocks(width-16,  param.Y_SEA+13, width-9,    width-16,  param.Y_SEA+17, width-9,    param.DARK       )
    mc.setBlocks(-width+16, param.Y_SEA+13, width-9,    -width+16, param.Y_SEA+17, width-9,    param.DARK       )
    ...
    mc.setBlocks(-width+9,  param.Y_SEA+13, width-16,   -width+9,  param.Y_SEA+17, width-16,   param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+13, -width+16,  -width+9,  param.Y_SEA+17, -width+16,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+19, -width+5,   width-5,   param.Y_SEA+19, width-5,    param.GOLD_BLOCK )
    mc.setBlocks(-width+8,  param.Y_SEA+20, -width+8,   width-8,   param.Y_SEA+20, width-8,    param.GOLD_BLOCK )
    mc.setBlocks(-width+10, param.Y_SEA+21, -width+10,  width-10,  param.Y_SEA+21, width-10,   param.GOLD_BLOCK )
    mc.setBlocks(-width+11, param.Y_SEA+22, -width+11,  width-11,  param.Y_SEA+22, width-11,   param.GOLD_BLOCK )
