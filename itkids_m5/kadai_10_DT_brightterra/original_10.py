...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(width-5,   param.Y_SEA+10, -width+5,   -width+10, param.Y_SEA+14, width-12,   param.GOLD_BLOCK )
    mc.setBlocks(width-5,   param.Y_SEA+13, -width+5,   -width+10, param.Y_SEA+13, width-12,   param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+15, -width+5,   width+10,  param.Y_SEA+15, width-12,   param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, -width+5,   width+10,  param.Y_SEA+15, width-13,   param.AIR        )
