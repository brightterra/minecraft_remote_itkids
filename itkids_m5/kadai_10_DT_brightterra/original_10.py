...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+1, param.Y_SEA+2,   -width+1,    -width+3,  param.Y_SEA+2, width-1,  param.FENCE     )
    mc.setBlocks(-width+2, param.Y_SEA+2,   -width+2,    -width+3,  param.Y_SEA+2, width-2,  param.AIR       )
