...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(width-4,  param.Y_SEA+3, width-4,    width-4,  param.Y_SEA+6, width-4,    param.DARK       )
    mc.setBlocks(-width+4, param.Y_SEA+3, -width+13,  -width+4, param.Y_SEA+6, -width+13,  param.DARK       )
    mc.setBlocks(-width+4, param.Y_SEA+3, -width+21,  -width+4, param.Y_SEA+6, -width+21,  param.DARK       )
    mc.setBlocks(-width+4, param.Y_SEA+3, -width+29,  -width+4, param.Y_SEA+6, -width+29,  param.DARK       )
