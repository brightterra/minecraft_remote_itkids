...
def Kinkakuji(mc, width=20 ,X=0 ,Z=0):
    ...
    mc.setBlocks(-width+4+X,  param.Y_SEA+3,  -width+5+Z,   width-4+X,   param.Y_SEA+7,  -width+5+Z,   param.SPRUCE     )
    ...
    mc.setBlocks(-width+2+X,  param.Y_SEA+8,  -width+2+Z,   param.LANTERN)
    mc.setBlocks(-width+2+X,  param.Y_SEA+8,  width-2+Z,    param.LANTERN)
    mc.setBlocks(width-2+X,   param.Y_SEA+8,  -width+2+Z,   param.LANTERN)
    mc.setBlocks(width-2+X,   param.Y_SEA+8,  width-2+Z,    param.LANTERN)
    ...
    mc.setBlocks(-width+1+X,  param.Y_SEA+15, -width+1+Z,   param.LANTERN)
    mc.setBlocks(-width+1+X,  param.Y_SEA+15, width-1+Z,    param.LANTERN)
    mc.setBlocks(width-1+X,   param.Y_SEA+15, -width+1+Z,   param.LANTERN)
    mc.setBlocks(width-1+X,   param.Y_SEA+15, width-1+Z,    param.LANTERN)
    mc.setBlocks(width-1+X,   param.Y_SEA+15, width-1+Z,    param.LANTERN)
