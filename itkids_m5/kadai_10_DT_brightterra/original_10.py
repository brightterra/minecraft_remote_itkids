...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+20, param.Y_SEA+13, -width+8,   -width+20, param.Y_SEA+17, -width+8,   param.DARK       )
    mc.setBlocks(width-8,   param.Y_SEA+13, -width+8,   width-8,   param.Y_SEA+17, -width+8,   param.DARK       )
    mc.setBlocks(width-8,   param.Y_SEA+13, -width+20,  width-8,   param.Y_SEA+17, -width+20,  param.DARK       )
    mc.setBlocks(width-8,   param.Y_SEA+13, width-8,    width-8,   param.Y_SEA+17, width-8,    param.DARK       )
    mc.setBlocks(width-20,  param.Y_SEA+13, width-8,    width-20,  param.Y_SEA+17, width-8,    param.DARK       )
    mc.setBlocks(-width+8,  param.Y_SEA+13, width-8,    -width+8,  param.Y_SEA+17, width-8,    param.DARK       )
    mc.setBlocks(-width+8,  param.Y_SEA+13, width-20,   -width+8,  param.Y_SEA+17, width-20,   param.DARK       )
