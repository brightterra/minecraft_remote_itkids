...
def Kinkakuji(mc, width=20 ,X=0 ,Z=0):
    ...
    mc.setBlocks(-width+1+X,  param.Y_SEA+17, -width+1+Z,   width-1+X,   param.Y_SEA+17, width-1+Z,    param.SPRUCE     )
    mc.setBlocks(-width+4+X,  param.Y_SEA+18, -width+4+Z,   width-4+X,   param.Y_SEA+18, width-4+Z,    param.SPRUCE     )
    mc.setBlocks(-width+6+X,  param.Y_SEA+19, -width+6+Z,   width-6+X,   param.Y_SEA+19, width-6+Z,    param.SPRUCE     )
