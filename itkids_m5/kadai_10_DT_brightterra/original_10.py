...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+9,  param.Y_SEA+10, -width+9,   width-9,   param.Y_SEA+14, width-9,    param.GOLD_BLOCK )
    mc.setBlocks(-width+9,  param.Y_SEA+13, -width+9,   width-9,   param.Y_SEA+13, width-9,    param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+15, -width+9,   width-9,   param.Y_SEA+15, width-9,    param.DARK       )
    mc.setBlocks(-width+10, param.Y_SEA+10, -width+10,  width-10,  param.Y_SEA+15, width-10,   param.AIR        )
    mc.setBlocks(-width+10, param.Y_SEA+15, -width+10,  width-10,  param.Y_SEA+15, width-10,   param.GLOWSTONE  )
    ...
    mc.setBlocks(-width+9,  param.Y_SEA+10, width-16,   -width+9,  param.Y_SEA+15, width-16,   param.DARK       )
    mc.setBlocks(-width+9,  param.Y_SEA+10, -width+16,  -width+9,  param.Y_SEA+15, -width+16,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+20, -width+5,   width-5,   param.Y_SEA+16, width-5,    param.GOLD_BLOCK )
