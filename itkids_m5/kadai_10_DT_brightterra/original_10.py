...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+2,  param.Y_SEA+8,  -width+2,   param.LANTERN)
    mc.setBlocks(-width+2,  param.Y_SEA+8,  width-2,    param.LANTERN)
    mc.setBlocks(width-2,   param.Y_SEA+8,  -width+2,   param.LANTERN)
    mc.setBlocks(width-2,   param.Y_SEA+8,  width-2,    param.LANTERN)
    ...
    mc.setBlocks(width-5,   param.Y_SEA+10, -width+5,   width-25,  param.Y_SEA+14, -width+12,  param.GOLD_BLOCK )
    mc.setBlocks(width-5,   param.Y_SEA+13, -width+5,   width-25,  param.Y_SEA+13, -width+12,  param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+15, -width+5,   width-25,  param.Y_SEA+15, -width+12,  param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, -width+5,   width-24,  param.Y_SEA+15, -width+11,  param.AIR        )
    mc.setBlocks(-width+5,  param.Y_SEA+10, -width+5,   -width+5,  param.Y_SEA+15, -width+5,   param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+10, -width+12,  -width+5,  param.Y_SEA+15, -width+12,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+10, -width+20,  -width+5,  param.Y_SEA+15, -width+20,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+10, -width+28,  -width+5,  param.Y_SEA+15, -width+28,  param.DARK       )
    mc.setBlocks(-width+5,  param.Y_SEA+10, width-5,    -width+5,  param.Y_SEA+15, width-5,    param.DARK       )
    mc.setBlocks(-width+12, param.Y_SEA+10, width-5,    -width+12, param.Y_SEA+15, width-5,    param.DARK       )
    mc.setBlocks(-width+20, param.Y_SEA+10, width-5,    -width+20, param.Y_SEA+15, width-5,    param.DARK       )
    mc.setBlocks(-width+28, param.Y_SEA+10, width-5,    -width+28, param.Y_SEA+15, width-5,    param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, width-5,    width-5,   param.Y_SEA+15, width-5,    param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, width-12,   width-5,   param.Y_SEA+15, width-12,   param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, width-20,   width-5,   param.Y_SEA+15, width-20,   param.DARK       )
    mc.setBlocks(width-5,   param.Y_SEA+10, width-28,   width-5,   param.Y_SEA+15, width-28,   param.DARK       )
    ...
    mc.setBlocks(-width+7,  param.Y_SEA+18, -width+7,   width-7,   param.Y_SEA+18, width-7,    param.SPRUCE     )
    mc.setBlocks(-width+10, param.Y_SEA+19, -width+10,  width-10,  param.Y_SEA+19, width-10,   param.SPRUCE     )
    mc.setBlocks(-width+12, param.Y_SEA+20, -width+12,  width-12,  param.Y_SEA+20, width-12,   param.SPRUCE     )
    mc.setBlocks(-width+1,  param.Y_SEA+15, -width+1,   param.LANTERN)
    mc.setBlocks(-width+1,  param.Y_SEA+15, width-1,    param.LANTERN)
    mc.setBlocks(width-1,   param.Y_SEA+15, -width+1,   param.LANTERN)
    mc.setBlocks(width-1,   param.Y_SEA+15, width-1,    param.LANTERN)
    mc.setBlocks(width-1,   param.Y_SEA+15, width-1,    param.LANTERN)
