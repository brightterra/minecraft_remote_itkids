...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width,   param.Y_SEA+1, -width,    width,    param.Y_SEA+1, width,    param.FENCE  )
    mc.setBlocks(-width+1, param.Y_SEA+1, -width+1,  width-1,  param.Y_SEA+1, width-1,  param.AIR    )
