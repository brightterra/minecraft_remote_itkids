...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+8,  param.Y_SEA+11, -width+8,   width-8,   param.Y_SEA+11, width-8,    param.GOLD_BLOCK )
    mc.setBlocks(-width+9,  param.Y_SEA+12, -width+9,   width-9,   param.Y_SEA+12, width-9,    param.GOLD_BLOCK )
