...
def Kinkakuji(mc, width=20):
    ...
    mc.setBlocks(-width+4, param.Y_SEA+3, -width+5,  width-4,  param.Y_SEA+6, width-4,  param.CONCRETE   )
    mc.setBlocks(-width+5, param.Y_SEA+3, -width+6,  width-5,  param.Y_SEA+6, width-5,  param.AIR        )
    mc.setBlocks(-width+5, param.Y_SEA+3, -width+6,  width-5,  param.Y_SEA+6, -width+6, param.DARK       )
    mc.setBlocks()
    mc.setblocks()
    mc.setBlocks()
    mc.setBlocks()
